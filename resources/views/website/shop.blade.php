...
@section('content')
@include('website.components.breadcrumb', ['pageName' => __('shop.shop')])
        ...
        <div class="col-md-9 order-2">
          ...
          <div class="row mb-5">
            ...
            <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
              <div class="block-4 text-center border">
                <figure class="block-4-image">
                  <a href="shop-single.html"><img src="{{asset('assets/images/cloth_1.jpg')}}" alt="{{ __('shop.image_placeholder') }}" class="img-fluid"></a>
                </figure>
            ...
            <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
              <div class="block-4 text-center border">
                <figure class="block-4-image">
                  <a href="shop-single.html"><img src="{{asset('assets/images/shoe_1.jpg')}}" alt="{{ __('shop.image_placeholder') }}" class="img-fluid"></a>
                </figure>
                <div class="block-4-text p-4">
            ...
            <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
              <div class="block-4 text-center border">
                <figure class="block-4-image">
                  <a href="shop-single.html"><img src="{{asset('assets/images/cloth_2.jpg')}}" alt="{{ __('shop.image_placeholder') }}" class="img-fluid"></a>
                </figure>
                <div class="block-4-text p-4">
            ...
            <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
              <div class="block-4 text-center border">
                <figure class="block-4-image">
                  <a href="shop-single.html"><img src="{{asset('assets/images/cloth_3.jpg')}}" alt="{{ __('shop.image_placeholder') }}" class="img-fluid"></a>
                </figure>
                <div class="block-4-text p-4">
                  <h3><a href="shop-single.html">{{ __('shop.t_shirt_mockup') }}</a></h3>
                  <p class="mb-0">{{ __('shop.finding_perfect', ['item' => __('shop.products')]) }}</p>
                  <p class="text-primary font-weight-bold">{{ __('shop.price_format', ['price' => 50]) }}</p>
                </div>
              </div>
