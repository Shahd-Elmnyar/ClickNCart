...
<div class="site-section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
            <h2 class="text-black">{{ json_decode($product->name, true)[auth()->user()->locale] ?? $product->name }}</h2>
            <p>{{ json_decode($product->content, true)[auth()->user()->locale] ?? $product->content }}</p>
